 ...
 * CleanHistory Class
 */
class CleanSimpleHistory {
	/**
	 * Init
	 */
	public static function init() {
		add_action( 'wp_ajax_wpmb_clean_simple_history', array( self::class, 'handle' ) );
	}
	/**
	...
	public static function handle(): void {
		...
		$nonce_action = 'week' === $scope ? 'clean_simple_history_week' : 'clean_simple_history_all';
